	...
	<body>
		...
		<main>
			<div class="container" style="padding: 30px;">
				<h4>ALBUM PURCHASE</h4>
				<form action="crudoperations.jsp" method="post" onsubmit="return validateForm()">
					<input type="hidden" name="role" value="user_album_purchase">
					<input type="hidden" name="al_id" value="<%=request.getParameter("a_id")%>">
					<input type="hidden" name="u_id" value="<%=request.getParameter("u_id")%>">
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="total_amount">Payable Amount</label>
							<input type="number" class="form-control" id="total_amount" name="total_amount" value="<%=request.getParameter("s_price")%>" placeholder="Payable Amount" readonly>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
