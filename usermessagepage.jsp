	...
	<body>
		...
		<main>
			<div class="container" style="padding: 30px;">
				<h4 class="text-center">Password has successfully sent to mail. Please check your mail.</h4>
				<p class="text-center"><a href="userlogin.jsp" style="text-decoration: none;">Click Here To Login</a></p>
			</div>
		</main>
		<!-- Main End -->
