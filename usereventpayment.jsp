	...
	<body>
		...
		<main>
			<div class="container" style="padding: 30px;">
				...
				<%
				int ue_price = Integer.parseInt(request.getParameter("price"));
				System.out.println(":::ue_price:::" + ue_price);
				int ue_ticket_count = Integer.parseInt(request.getParameter("user_ticket_count"));
				System.out.println(":::ue_ticket_count:::" + ue_ticket_count);
				
				int final_amount = ue_price * ue_ticket_count;
				
				
				
				%>
				<form action="crudoperations.jsp" method="post" onsubmit="return validateForm()">
					<input type="hidden" name="role" value="user_event_book">
					<input type="hidden" name="user_ticket_count" id="user_ticket_count" value="<%=request.getParameter("user_ticket_count")%>">
					<input type="hidden" name="eid" id="eid" value="<%=request.getParameter("id")%>">
					<input type="hidden" name="e_price" id="e_price" value="<%=request.getParameter("price")%>">
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="total_amount">Payable Amount</label>
							<input type="number" class="form-control" id="total_amount" name="total_amount" value="<%=final_amount%>" placeholder="Total Amount" readonly>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
