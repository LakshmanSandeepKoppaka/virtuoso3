				...
				<form action="crudoperations.jsp" method="post">
					...
					<div class="form-row">
						<div class="col-md-6 mb-3">
							...
							<input type="text" class="form-control" id="ev_name" name="ev_name" placeholder="Enter Event Name" required>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="ev_price">Price</label>
							<input type="number" class="form-control" id="ev_price" name="ev_price" placeholder="Enter Price per Ticket" required>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="ev_date">Date</label>
							<input type="date" class="form-control" id="ev_date" name="ev_date" placeholder="Enter Date" required>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="ev_time">Time</label>
							<input type="time" class="form-control" id="ev_time" name="ev_time" placeholder="Enter Time" required>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="ev_location">Location</label>
							<input type="text" class="form-control" id="ev_location" name="ev_location" placeholder="Enter Event Location" required>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="ev_total_tickets">Total Tickets</label>
							<input type="number" class="form-control" id="ev_total_tickets" name="ev_total_tickets" placeholder="Enter Total Tickets" required>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="ev_coord_name">Coordinator Name</label>
							<input type="text" class="form-control" id="ev_coord_name" name="ev_coord_name" placeholder="Enter Coordinator Name" required>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="ev_coord_mobile">Coordinator Contact</label>
							<input type="number" class="form-control" id="ev_coord_mobile" name="ev_coord_mobile" placeholder="Enter Coordinator Mobile Number" required>
						</div>
					</div>
