	...
	<body onload="defaultValues()">
		...
		<main>
			<div class="container" style="padding: 30px;">
				...
				<form action="adminaddproduct1.jsp" method="post" enctype="multipart/form-data">
					...
					<div class="form-row">
						<div class="col-md-6 mb-3">
							...
							<input type="number" class="form-control" id="pr_quantity" name="pr_quantity" placeholder="Enter Quantity" required>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="pr_desc">Product Details</label>
							<textarea class="form-control" name="pr_desc" id="pr_desc" placeholder="Enter Product Details" rows="6" required></textarea>
						</div>
					</div>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="pr_stock">Stock?</label>
							<select class="form-control" id="pr_stock" name="pr_stock" required>
					...
					<div class="form-row">
						<div class="col-md-6 mb-3">
							...
							<input type="file" class="form-control" id="pr_image" name="pr_image" accept="image/*" placeholder="Choose Image" required>
						</div>
					</div>
