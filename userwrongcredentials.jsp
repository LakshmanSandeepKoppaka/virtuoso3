	...
	<body>
		...
		<main>
			<div class="container" style="padding: 30px;">
				<h4>USER LOGIN</h4>
				<p style="color: orangered; margin-top: 15px;">Username/Password is incorrect or no account is found with this credentials.</p>
				<p style="color: orangered; margin-bottom: 15px;">Please enter correct credentials or Register into this site for login.</p>
				...
				<div style="margin-top: 20px;">
					<a href="userforgotpassword.jsp" style="text-decoration: none;">Forgot Password??</a>
				</div>
				<div style="margin-top: 10px;">
					<a href="userreg.jsp" class="form-ahref" style="text-decoration: none;">No Login Credentials??Click Here!!</a>
				</div>
			</div>
		</main>
		<!-- Main End -->
