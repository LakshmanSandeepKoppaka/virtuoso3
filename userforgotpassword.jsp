		...
		<main>
			<div class="container" style="padding: 30px;">
				...
				<form action="crudoperations.jsp" method="post">
					<input type="hidden" name="role" value="user_forgot_password">
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="fp_email">Email ID</label>
							<input type="email" class="form-control" id="fp_email" name="fp_email" placeholder="Enter Email ID" required>
						</div>
					</div>
